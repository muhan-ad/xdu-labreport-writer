...
const commands = [[process.execPath, ['--test', 'tests/regression.test.js', 'tests/security.test.js', 'tests/ocr.test.js']],
  ...['smoke_test.py', 'validate_schema.py', 'tests/calculation_test.py', 'tests/omml_test.py', 'tests/quiz_polish_test.py', 'tests/custom_plot_test.py', 'tests/plot_runner_test.py'].map(file => [python, ['-B', '-X', 'utf8', file]])];
